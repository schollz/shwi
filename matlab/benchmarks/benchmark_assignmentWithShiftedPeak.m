...
trueCidx = [];
for i=1:50
    r{i}.L = [ 30 + lcSD.*randn(1,1) 60 + lcSD.*randn(1,1) 120 + lcSD.*randn(1,1)];
    trueCidx(i) = 1;
end
for i=50:100
    r{i}.L = [ 30 + lcSD.*randn(1,1) 60+ deltaLc + lcSD.*randn(1,1) 120 + lcSD.*randn(1,1)];
    trueCidx(i) = 2;
end
% for i=60:70
